...
| 🎙️ **双语分镜脚本** | 输出 2 套完整剧本，含配音口播 + 画面分镜 + 关键字幕标注，大量使用 Gen Z 俚语。纯净可复制版本为纯文本（无时间轴/引号） |
| 🏷️ **精准标签矩阵** | 10 个层级化 Hashtag，一行连续输出，直接可复制 |
| 🤖 **AI 视频提示词** | 自动将脚本转化为 Seedance 2.0 兼容的中文 Prompt，放入 code block 无额外标签，一键复制 |
...
- 价格：$25
- 对标案例：examples/roller_sharpener_case.md
```
...
```
tiktok_viral_script_skill_export/
...
│   ├── roller_sharpener_case.md              #    框架 A 案例
│   └── tape_case.md                    #    框架 D 案例
├── resources/                        # 📦 策略资源库
│   ├── core_strategies/              #    核心方法论
│   │   ├── cta_call_to_action.md             #    CTA 设计指南
│   │   ├── tiktok_completion_rate_strategy.md #   完播率优化策略
│   │   ├── hook_golden_3_seconds.md         #    12 种 Hook 类型
│   │   └── marketing_psychology.md              #    心理触发器手册
...
8. ✅ 所有英文文案是否都附有中文翻译
9. ✅ 纯净可复制版本是否为纯文本（无时间轴、无引号、无 `Prompt:` 标签）
