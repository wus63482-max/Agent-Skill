...
**Segment [N] ([合并后的时间段])**:
Prompt: [人物文本大锁 (Character Bible Prompt)] 接着进行具体分段描绘，自然平滑地使用 @标签（如 @视频1, @图片1）指代核心互动，结构化用中文描述画面细节、角色动作与表情，强调手持感与不完美真实感。将角色的英文口播台词直接用引号嵌入画面描述中。在末尾描述背景音乐风格和环境音效。
...
- **美妆/护肤品真人实测 (Skin Care Test)**：
  - **Prompt**: `让角色在浴室镜子前使用精华液 @图片1。模仿视频 @视频1 的手持拍摄感。画面要有手机自拍的颗粒感和轻微晃动。光影是浴室的暖黄灯光。强调角色真实的皮肤纹理。角色表情自然，带一点发现好物的惊喜感，惊喜地说 "Wait, this texture is actually insane." 真实的家庭环境，没有影棚灯光，充满真人生活气息。背景是带有轻微浴室回声的自然环境底噪。`
- **家居/生活好物分享 (Home Gadget)**：
  - **Prompt**: `第一人称视角 (POV) 展示产品 @图片1 在凌乱的厨房台面上。镜头像 @视频1 那样推进，展示产品的使用细节。镜头对焦要有手机自动对焦的起伏感。角色一边操作一边轻松地说 "Bro, where has this been my whole life?" 真实的美国普通家庭背景，凌乱但真实，iPhone 15 Pro 竖屏拍摄画质。背景是轻松时尚的 TikTok 音乐，混合厨房环境噪音。`

**POV 模式原生感实战提示词模板参考**（`视角：POV` 触发）：
- **工具类 POV 开箱使用 (Tool Unboxing & Demo)**：
  - **Prompt**: `第一人称 POV 手持拍摄视角，一双肤色偏白的男性手，手腕上戴着一块黑色运动表，穿着灰色连帽衫的袖口微微卷起，iPhone 15 Pro 竖屏拍摄画质。一双手从快递盒中取出产品 @图片1，放在美式厨房木质台面上。手拿起产品翻转检查，然后将一把明显很钝的菜刀放上去，稳定有力地推刀五下，像 @视频1 的磨刀节奏。手停顿一拍，然后将磨好的刀轻松切下一片番茄——薄如蝉翼，镜头快推特写切面。真实的美国普通家庭厨房背景，凌乱但真实。背景是拆箱纸板声、金属摩擦的 ASMR 声效和轻松的 TikTok 音乐。画外音旁白：轻松的男声语气说 "Dude, five strokes. That's literally it."`
- **电子产品 POV 桌面体验 (Tech Desk Setup)**：
  - **Prompt**: `第一人称 POV 手持拍摄视角，一双干净的手，左手无名指上戴着一枚简约银色戒指，穿着黑色长袖的袖口，iPhone 15 Pro 竖屏拍摄画质。一双手拆开白色极简包装盒，取出一个无线充电器 @图片1 放在杂乱的书桌上。手拿起手机往上一放——充电动画立即亮起，镜头微微推近捕捉屏幕画面。手满意地竖起大拇指入镜。真实的美国学生公寓桌面环境，有饮料罐和便签纸。背景是电子设备轻微的嗡鸣声和手指轻敲桌面的声效。画外音旁白：兴奋的声音说 "No cable, no waiting, it just works."`
